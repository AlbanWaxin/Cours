...
<?php
    ...
    print '<div id="welcome"> Bonjour, Monsieur ' .$_SESSION['login'].' <form id="disconnect" method="post" action="../modele/logout.php"><p><input type ="submit" id="disconect" name="disconnect" value = "Déconnexion"></p></form></div>';
